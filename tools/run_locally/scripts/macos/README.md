...
3. Start one secondary per atSign, each on a unique port:
...
The important rule: each secondary needs its own atSign, port, and storage directory. The provided script handles the storage separation with paths like storage_@alice, storage_@bob, etc.

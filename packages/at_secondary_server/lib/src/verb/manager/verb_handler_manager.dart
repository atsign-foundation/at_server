...
class DefaultVerbHandlerManager implements VerbHandlerManager {
  ...
  DefaultVerbHandlerManager(this.keyStore, this.outboundClientManager) {
    _loadVerbHandlers();
  }
  ...
  List<VerbHandler> _loadVerbHandlers() {
    ...
    _verbHandlers.add(ProxyLookupVerbHandler(keyStore, outboundClientManager));
    _verbHandlers.add(LookupVerbHandler(keyStore, outboundClientManager));
    _verbHandlers.add(ScanVerbHandler(keyStore, outboundClientManager));

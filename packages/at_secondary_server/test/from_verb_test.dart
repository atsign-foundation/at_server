...
void main() async {
  ...
  group('A group of from verb accept test', () {
    test('test from accept', () {
      var command = 'from:$alice';
      var handler = FromVerbHandler(mockKeyStore, mockOcm,
  ...
  group('A group of from verb handler tests', () {
    test('test from verb handler getVerb', () {
      var verbHandler = FromVerbHandler(keyValueStore, mockOcm,
          accessLog: atAccessLog, disablePqAuth: true);
    ...
    /*test(
        ...
        () async {
      var verbHandler = FromVerbHandler(keyValueStore, mockOcm, accessLog: atAccessLog, disablePqAuth: true);

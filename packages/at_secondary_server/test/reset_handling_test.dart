    ...
    test('lookup some bob key, bob public encryption key unchanged', () async {
      ...
      await expectLater(
          lookupVerbHandler.process(
              'lookup:all:$nonExistentKeyName', inboundConnection),
          throwsA(isA<KeyNotFoundException>()));
      AtData cachedBobPublicKeyData = (await cacheManager
      ...
      cachedBobPublicKeyData = (await cacheManager.get(cachedBobsPublicKeyName,

...
class AtMetaDataAdapter extends TypeAdapter<AtMetaData> {
  ...
  AtMetaData read(BinaryReader reader) {
    ...
    return AtMetaData()
      ...
      ..availableAt = fields[7] as DateTime?
      ..ttb = (fields[8] as num?)?.toInt()
      ..ttl = (fields[9] as num?)?.toInt()
      ..ttr = (fields[10] as num?)?.toInt()
      ..refreshAt = fields[11] as DateTime?
      ..isCascade = fields[12] as bool?

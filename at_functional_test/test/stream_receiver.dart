...
void main() async {
  try {
    var atsign = '@bob🛠';
    var preference = getBobPreference(atsign);
...
void _streamCompletionCallBack(var streamId) {
  ...
  AtClientPreference getBobPreference(String atsign) {
    ...
    preference.hiveStoragePath = 'hive_receiver/client';
    preference.commitLogPath = 'hive_receiver/client/commit';
    preference.isLocalStoreRequired = true;
    preference.syncStrategy = SyncStrategy.IMMEDIATE;
    preference.downloadPath = '/home/shaikirfan/Documents/updated-tests/at_server/at_functional_test';

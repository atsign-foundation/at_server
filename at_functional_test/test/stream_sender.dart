...
void main() async {
  try {
    ...
    await atClient.startMonitor(
        ...
        null);
    var streamResult =
        await atClient.stream('@bob🛠', 'download.jpeg',namespace: 'atmosphere');
    print(streamResult);
...
AtClientPreference getAlicePreference(String atsign) {
  ...
  preference.hiveStoragePath = '/hive_sender/client';
  preference.commitLogPath = '/hive_sender/client/commit';

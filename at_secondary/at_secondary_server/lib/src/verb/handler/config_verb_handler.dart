  ...
  Future<void> processVerb(
    ...
    try {
      ...
      if (operation != null) {
        ...
        switch (setOperation) {
          case 'set':
            if (AtSecondaryConfig.testingMode.toString() == 'true' || AtSecondaryConfig.testingMode) {
              ...
              result = Platform.environment.containsKey('testingMode').toString() + Platform.environment['testingMode'].toString()+AtSecondaryConfig.testingMode.toString();
            }
            break;
          case 'reset':

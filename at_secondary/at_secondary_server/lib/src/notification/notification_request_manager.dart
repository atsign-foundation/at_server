...
class NotificationRequestManager {
  ...
  NotificationRequest getNotificationRequest(String version) {
    switch (version) {
      case '3.0.12':
        return NotificationRequest3012();
      case '3.0.13':
        return NotificationRequest3013();
      default:
        return NotificationRequest3013();
    }
  }
...
class NotificationRequest3012 implements NotificationRequest {
  @override
  late String request;
  ...
  NotificationRequest prepareNotificationReqeust(
    ...
    var notification = NotificationRequest3012();
...
class NotificationRequest3013 extends NotificationRequest3012 {
  NotificationRequest getNotificationRequest(AtNotification atNotification) {
